...
<body>
	<nav>
		...
		<ul id="navigat">
			<li onclick="window.open('..login/home.html','_self')">ㅡ HOME</li><br>
		...
		<!-- 로그인시 기능동작 -->
		<?php } else { ?>	
            <li onclick="window.open('../zerofee/zero_fee.php','_self')">ㅡ 0원 등록 신청</li><br>
		<?php } ?>
...
<?
	...
	if(!($sdtinfo[0] == "")) {
		...
		학기
		<SELECT name="select">
			<option value="20211" selected>2021년도 1학기</option>
			<option value="20202">2020년도 2학기</option>
			<option value="20201">2020년도 1학기</option>
			<option value="20192">2019년도 2학기</option>
		</SELECT><br>
		...
		<table border=1 width=1000 height=100 align=center>
			...
			<td colspan=1 align=center>과목코드</td>
			<td colspan=2 align=center>과목명</td>
			<td colspan=1 align=center>이수구분</td>
			<td colspan=1 align=center>학점</td>
			<td colspan=1 align=center>등급</td>
			</tr>

			<tr>
			<td colspan=1 align=center>'.$sdtinfo[0].'</td>
			<td colspan=1 align=center>'.$sdtinfo[1].'</td>
			<td colspan=2 align=center>'.$sdtinfo[2].'</td>
			<td colspan=1 align=center>'.$sdtinfo[3].'</td>
			<td colspan=1 align=center>'.$sdtinfo[4].'</td>
			<td colspan=1 align=center>'.$sdtinfo[5].'</td>
			</tr>';
